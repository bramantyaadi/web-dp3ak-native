          ...
          <div class="col-md-8 padding-bottom-20 left-column no-padding">
              ...
              <div class="row">		
                  <?php 
                      ...
                      <article class="content-box box-img bg-light box-clickable media">
                          <div class="box-body media">
                              ...
                              <div class="media-body">
                                  <h3>
                                      <a href="detail-artikel-<?php echo $r['id_berita']."-".$r['judul_seo'].".html"; ?>"><?php echo $r['judul']; ?></a>
                                  </h3>

                                  <ul class="list-inline small">
                                      <li><span class="label label-warning"><i class="fa fa-calendar"></i> <?php echo $r['tanggal'] ?></span></li>
                    ...
                    $jmldata     = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM berita WHERE id_kategori='".$val->validasi($_GET['id'],'sql')."'"));
