			...
			<div class="col-md-8 padding-bottom-20 left-column no-padding">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<h1 class="breadcrumb-page-title">Daftar Situs Terkait</h1>
							</div> <!-- .col-md-6 -->
							<div class="col-md-6 col-sm-6 col-xs-12">
								<ol class="breadcrumb">
				...
				<?php 
				  // Tampilkan semua agenda
				 	$sql = mysqli_query($koneksi, "SELECT * FROM situs WHERE aktif='Y' ORDER BY id_situs ASC");		 
				  while($d=mysqli_fetch_array($sql)){
				    ?>
				         <div class="w3-panel w3-blue w3-padding-16"> 
                        <a href="<?php echo $d['url'];?>" target="_blank" class="w3-text-white"><i class="fa fa-external-link"></i> <?php echo $d['nama_situs'];?></a>
				  		</div>
						  <?php } ?>
					</div>	
				</div>
