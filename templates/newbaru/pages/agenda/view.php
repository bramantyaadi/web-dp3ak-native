	...
	<div id="bootstrap-touch-slider" class="carousel bs-slider fade control-round indicators-line" data-ride="carousel" data-interval="4500" >
		...
		<div class="carousel-inner" role="listbox">
			...
			<a href="<?php echo $tsd['link']; ?>" target="_blank">
				<!-- Slide Background -->
				<img src="./foto_slider/<?php echo $tsd['gmb_slider']; ?>" alt="" class="w3-image"/>
				    ...
				    ?>
						...
						<article class="content-box box-img bg-light box-clickable media">
							<div class="box-body media">
								...
								<h4 class="media-heading"><?php echo $d['tema']; ?></h4>
								<i class="fa fa-calendar"></i> <?php echo $tgl_posting; ?><br>
								<i class="fa fa-map-marker"></i> <?php echo $d['tempat']." - ".$tgl_mulai." s/d ".$tgl_selesai.", Pukul ".$d['jam']; ?><br>
								<i class="fa fa-user"></i> <?php echo $d['pengirim']; ?>
